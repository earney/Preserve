## {{{ http://code.activestate.com/recipes/162292/ (r3)
...
class xcopier(copier):
  ...
  def xcopy(self, input=None):
    ...
    import io
    yinf = io.StringIO(self._x2y_translate(inputText))
    self.copy(inf=yinf)
    yinf.close()
...
if __name__ == '__main__':
  ...
  #from cStringIO import StringIO
  import io
  templateStream = io.StringIO(templateString)
...
####################################################  
## end of http://code.activestate.com/recipes/162292/ }}}
